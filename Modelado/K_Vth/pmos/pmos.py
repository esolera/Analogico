...
def lineal(x,m,b):
	...
	return lineal
df = pd.read_csv("/media/esolera/ExtraDrive1/TEC/cuatri_2/analogico/hspice_Analogico/modelado/Vth_k/pmos.csv",header=None)
x_axis=df[0]
y_axis=df[1]*1e6


index=find_point(x_axis,0.8)
